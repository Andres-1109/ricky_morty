import { getCharacterById, getEpisodesByIds } from '../services/rickmorty.js'
...
export async function renderCharacterDetail(container, id) {
  ...
  try {
    ...
    img.addEventListener('error', function () {
      this.outerHTML = '<div class="w-full md:w-80 h-80 flex items-center justify-center bg-(--rm-bg-card) text-(--rm-text-muted)">Sin imagen</div>'
    })
